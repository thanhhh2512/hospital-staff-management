  ...
  fetchProfile: async (employeeId: string): Promise<void> => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        console.warn('Profile API response not successful:', response);
        set({
          hasProfile: false,
          isLoading: false,
    ...
    try {
      ...
      if (response.success && response.data) {
        const createdProfile: Profile = {
          ...
          email: response.data.email || "",
          permanentAddress: response.data.permanentAddress ?
            `${response.data.permanentAddress.street}, ${response.data.permanentAddress.ward}, ${response.data.permanentAddress.district}, ${response.data.permanentAddress.city}` : "",
          currentAddress: response.data.currentAddress ?
            `${response.data.currentAddress.street}, ${response.data.currentAddress.ward}, ${response.data.currentAddress.district}, ${response.data.currentAddress.city}` : "",
          avatar: response.data.avatar || null,
          position: data.position,
          department: data.department,
          jobTitle: data.jobTitle,
          hireDate: data.hireDate,
          hireAgency: data.hireAgency,
          rank: data.rank,
          salary: data.salary,
          ...
          partyOfficialDate: data.partyOfficialDate,
          health: data.health,
          familyPolicy: data.familyPolicy,
          socialOrgJoinDate: data.socialOrgJoinDate,
          enlistmentDate: data.enlistmentDate,
          dischargeDate: data.dischargeDate,
          highestMilitaryRank: data.highestMilitaryRank,
